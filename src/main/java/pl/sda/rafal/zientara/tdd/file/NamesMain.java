    ...
    private static String getResultReport(String[] maleNames, String[] femaleNames) {
        ...
        for (char i = 'A'; i <= 'Z'; i++) {
            ...
            if (maleCount > femaleCount) {
                builder.append("Wi�cej imion m�skich na liter� ").append(currentLetter);
            } else if (maleCount < femaleCount) {
                builder.append("Wi�cej imion �e�skich na liter� ").append(currentLetter);
            }
            if (maleCount == femaleCount) {
                builder.append("Tyle samo imion m�skich i �e�skich na liter� ").append(currentLetter);
            }
